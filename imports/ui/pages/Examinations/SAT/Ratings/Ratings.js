...
// collections
import SatRatings from '../../../../../api/sat/ratings/ratings';
...
const Ratings = props => {
  ...
  const lookupParser = fieldName => {
    return Meteor.apply('satRatings.getDistinct', [fieldName], {
...
export default withTracker(props => {
  ...
  const ratingsSub = Meteor.subscribe('satRatings.all');
  const ratings = SatRatings.find().fetch();
